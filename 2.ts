...
interface ITask {
  ...
  title: string;
  completed: boolean;
  priority?: 'low' | 'medium' | 'high'; // опциональное поле, так как есть объекты без priority
}

// tasks - типизирован как массив объектов ITask
const tasks: ITask[] = [
...
// Функция принимает массив ITask и возвращает массив ITask
